...
export default {
    ...
    [
      "classic",
      {
        "docs": {
          ...
          "editUrl": "https://github.com/arvind3/merchandising-core-concepts-for-grocery-business/tree/main/",
          "routeBasePath": "/"
        },
        "theme": {
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2026 Arvind Bhardwaj. Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
